\begin{frame}{Chiffrement \`a clef publique}

  Chiffrement asymm\'etrique (Example: sch\'ema de chiffrement ElGamal)

  $\G$ un group d'ordre premier $p$, $(g, m) \in \G^2$ et $(a,r) \sample \mathbb{Z}_p^2$.  
  \begin{figure}
    \tiny
    \begin{centering}
      \begin{tikzpicture}
